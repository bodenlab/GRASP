#'Get a vector of extant sequence names
#'
...
get_extant_sequence <- function(asrStructure) {
  print("Under construction")
}

#'Get a vector of internal sequence names
#'
...
get_internal_sequence <- function(asrStructure) {
  print("Under construction")
}
