...
class ASRController {
    ...
    public String performReconstruction(@Valid @ModelAttribute("asrForm") ASR asr, BindingResult bindingResult, Model model){
        ...
        try {
           ...
           // System.out.println(asr.getMSAGraphJSON().toString());
